...
import {ChainConfig} from "gvosjs-ws";
    ...
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("From WIF", function() {
                var private_key = PrivateKey.fromWif(
                    key.private_key_WIF_format
                );
...
test({
    ...
    public_key: "TEST7jDPoMwyjVH5obFmqzFNp4Ffp7G2nvC7FKFkrMBpo7Sy4uq5Mj",
    private_key:
    ...
    bts_address: "TEST8DvGQqzbgCR5FHiNsFf8kotEXr8VKD3mR",
    ...
    Uncompressed_BTC: "TESTLAFmEtM8as1mbmjVcj5dphLdPguXquimn",
    Compressed_BTC: "TESTANNTSEaUviJgWLzJBersPmyFZBY4jJETY",
    Uncompressed_PTS: "TESTEgj7RM6FBwSoccGaESJLC3Mi18785bM3T",
    Compressed_PTS: "TESTD5rYtofD6D4UHJH6mo953P5wpBfMhdMEi",
    null_public_key: "TEST1111111111111111111111111111111114T1Anm"
});
